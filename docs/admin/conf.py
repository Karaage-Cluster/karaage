...
latex_documents = [
  ('index', 'Karaage.tex', u'Karaage Documentation',
   u'Brian May', 'manual'),
]
...
man_pages = [
    ('index', 'karaage', u'Karaage Documentation',
     [u'Brian May'], 1)
]
...
texinfo_documents = [
  ('index', 'Karaage', u'Karaage Documentation',
   u'Brian May', 'Karaage', 'One line description of project.',
   'Miscellaneous'),
]
