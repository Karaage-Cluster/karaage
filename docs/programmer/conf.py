...
MOCK_MODULES += ['tldap', 'tldap.schemas', 'tldap.schemas.ds389', 'tldap.schemas.rfc', 'tldap.transaction', 'tldap.manager', ]
MOCK_MODULES += ['tldap.methods', 'tldap.methods.common', 'tldap.methods.ldap_passwd', 'tldap.methods.pwdpolicy', 'tldap.methods.ds389' ]
MOCK_MODULES += ['smbpasswd', 'captcha', 'captcha.fields', 'ajax_select', 'ajax_select.fields', 'django_xmlrpc', 'matplotlib']
