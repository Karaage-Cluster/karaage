...
def search(request):
    ...
    if 'sitesearch' in request.GET and request.GET['sitesearch'].strip() != "":
        ...
        for term in term_list:
            q = Q(username__icontains=term) | Q(first_name__icontains=term) | Q(last_name__icontains=term) | Q(email__icontains=term)
            query = query & q
        ...
        query = Q()
        for term in term_list:
            q = Q(pid__icontains=term) | Q(name__icontains=term) | Q(leaders__username__icontains=term) | Q(leaders__first_name__icontains=term) | Q(leaders__last_name__icontains=term)
            query = query & q
