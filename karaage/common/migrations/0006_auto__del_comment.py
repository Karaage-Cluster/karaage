...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'comments', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'comment_comments', null=True, to=orm['people.Person'], blank=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'content_type_set_for_comment', to=orm['contenttypes.ContentType'])),
