...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cache_institutecache', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutes.Institute']))
        # Adding field 'UserCache.machine_category'
        db.add_column(u'cache_usercache', 'machine_category',
    ...
    models = {
        ...
        u'cache.projectcache': {
            ...
            'machine_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['machines.MachineCategory']"}),
            'no_jobs': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'pid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Project']"}),
            'start': ('django.db.models.fields.DateField', [], {})
        },
        u'cache.usercache': {
