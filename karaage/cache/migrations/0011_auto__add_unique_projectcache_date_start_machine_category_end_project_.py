...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PersonCache', fields ['date', 'start', 'end', 'project', 'person']
        db.create_unique(u'cache_personcache', ['date', 'start', 'end', 'project_id', 'person_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'PersonCache', fields ['date', 'start', 'end', 'project', 'person']
        db.delete_unique(u'cache_personcache', ['date', 'start', 'end', 'project_id', 'person_id'])
    ...
    models = {
        ...
        u'cache.personcache': {
            'Meta': {'unique_together': "(('date', 'start', 'end', 'person', 'project'),)", 'object_name': 'PersonCache'},
            'cpu_hours': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '30', 'decimal_places': '2', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 17, 0, 0)'})
        }
    }
