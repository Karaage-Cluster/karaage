...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('project', (
            ...
            ('leader', self.gf('django.db.models.fields.related.ForeignKey')(related_name='leader', to=orm['people.Person'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_approved', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('is_expertise', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ...
            ('approved_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_approver', null=True, to=orm['people.Person'])),
            ('date_approved', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('deleted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='project_deletor', null=True, to=orm['people.Person'])),
