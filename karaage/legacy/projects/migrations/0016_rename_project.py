...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename stuff
        db.rename_table('projects_projecttmp', 'project')
        db.rename_table('projects_projecttmp_leaders', 'project_leaders')
        db.rename_column('project_leaders', 'projecttmp_id', 'project_id')
        db.rename_column('project_quota', 'project_tmp_id', 'project_id')
    ...
    def backwards(self, orm):
        ...
        # Rename stuff
        db.rename_table('project', 'projects_projecttmp')
        db.rename_table('project_leaders', 'projects_projecttmp_leaders')
        db.rename_column('projects_projecttmp_leaders', 'project_id', 'projecttmp_id')
        db.rename_column('project_quota', 'project_id', 'project_tmp_id')
    ...
    complete_apps = ['contenttypes', 'projects']
