...
class Migration(DataMigration):
        ...
        for person in orm.person.objects.iterator():
            ...
            if person.user.is_active:
                ...
                try:
                    ...
                    # has no access.
                    print(
                        "+++ person username=%s has no ldap entry; "
                        "user's password will be invalid"
                        % person.username)
    ...
    models = {
        ...
        'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 24, 0, 0)'})
        }
    }

    complete_apps = ['machines', 'people']
    symmetrical = True
