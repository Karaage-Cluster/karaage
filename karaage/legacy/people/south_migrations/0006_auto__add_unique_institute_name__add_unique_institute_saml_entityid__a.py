...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Institute', fields ['saml_entityid']
        db.create_unique('institute', ['saml_entityid'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Institute', fields ['saml_entityid']
        db.delete_unique('institute', ['saml_entityid'])
