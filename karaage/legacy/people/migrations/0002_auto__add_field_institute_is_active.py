...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Institute.is_active'
        db.add_column('institute', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Institute.is_active'
        db.delete_column('institute', 'is_active')
