...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cache_institutecache', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutes.Institute']))
        # Adding field 'UserCache.machine_category'
        db.add_column('cache_usercache', 'machine_category',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'InstituteCache.institute'
        db.alter_column('cache_institutecache', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Institute']))
        # Deleting field 'UserCache.machine_category'
        db.delete_column('cache_usercache', 'machine_category_id')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 29, 0, 0)'})
        }
    }
