...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('cache_projectcache', ['date', 'start', 'machine_category_id', 'end', 'project_id'])

        # Adding unique constraint on 'PersonCache', fields ['end', 'person', 'project', 'start', 'machine_category', 'date']
        db.create_unique('cache_personcache', ['end', 'person_id', 'project_id', 'start', 'machine_category_id', 'date'])

        # Adding unique constraint on 'InstituteCache', fields ['date', 'start', 'machine_category', 'end', 'institute']
        db.create_unique('cache_institutecache', ['date', 'start', 'machine_category_id', 'end', 'institute_id'])

        # Adding unique constraint on 'MachineCache', fields ['date', 'start', 'machine', 'end']
        db.create_unique('cache_machinecache', ['date', 'start', 'machine_id', 'end'])

    def backwards(self, orm):
        # Removing unique constraint on 'MachineCache', fields ['date', 'start', 'machine', 'end']
        db.delete_unique('cache_machinecache', ['date', 'start', 'machine_id', 'end'])

        # Removing unique constraint on 'InstituteCache', fields ['date', 'start', 'machine_category', 'end', 'institute']
        db.delete_unique('cache_institutecache', ['date', 'start', 'machine_category_id', 'end', 'institute_id'])

        # Removing unique constraint on 'PersonCache', fields ['end', 'person', 'project', 'start', 'machine_category', 'date']
        db.delete_unique('cache_personcache', ['end', 'person_id', 'project_id', 'start', 'machine_category_id', 'date'])

        # Removing unique constraint on 'ProjectCache', fields ['date', 'start', 'machine_category', 'end', 'project']
        db.delete_unique('cache_projectcache', ['date', 'start', 'machine_category_id', 'end', 'project_id'])
