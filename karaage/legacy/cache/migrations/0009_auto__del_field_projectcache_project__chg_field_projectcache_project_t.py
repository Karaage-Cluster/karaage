...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cache_projectcache', 'project_id')

        # Changing field 'ProjectCache.project_tmp'
        db.alter_column('cache_projectcache', 'project_tmp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectTmp']))
        # Deleting field 'PersonCache.project'
        db.delete_column('cache_personcache', 'project_id')

        # Changing field 'PersonCache.project_tmp'
        db.alter_column('cache_personcache', 'project_tmp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectTmp']))

    def backwards(self, orm):
        # Adding field 'ProjectCache.project'
        db.add_column('cache_projectcache', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']),
                      keep_default=False)

        # Changing field 'ProjectCache.project_tmp'
        db.alter_column('cache_projectcache', 'project_tmp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectTmp'], null=True))
        # Adding field 'PersonCache.project'
        db.add_column('cache_personcache', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project']),
                      keep_default=False)

        # Changing field 'PersonCache.project_tmp'
        db.alter_column('cache_personcache', 'project_tmp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectTmp'], null=True))
