...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cache', ['TaskMachineCategoryCache'])
        ...
        db.send_create_signal('cache', ['TaskCacheForProject'])
        ...
        db.send_create_signal('cache', ['TaskCacheForInstitute'])
        ...
        db.send_create_signal('cache', ['TaskCacheForMachineCategory'])
    ...
    models = {
        ...
        'cache.taskcacheformachinecategory': {
        ...
        'cache.taskmachinecategorycache': {
