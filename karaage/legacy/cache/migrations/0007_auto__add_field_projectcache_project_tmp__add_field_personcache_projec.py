...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cache_projectcache', 'project_tmp',
        ...
        db.add_column('cache_personcache', 'project_tmp',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectTmp'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ProjectCache.project_tmp'
        db.delete_column('cache_projectcache', 'project_tmp_id')

        # Deleting field 'PersonCache.project_tmp'
        db.delete_column('cache_personcache', 'project_tmp_id')
