...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('cache_usercache', 'user_id', 'person_id')
        db.rename_column('cache_projectcache', 'pid_id', 'project_id')

    def backwards(self, orm):
        db.rename_column('cache_usercache', 'person_id', 'user_id')
        db.rename_column('cache_projectcache', 'project_id', 'pid_id')
