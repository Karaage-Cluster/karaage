...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for src in orm.UserApplication.objects.iterator():
            values = {
                ...
                'header_message': src.header_message,
                '_class': 'projectapplication',
                'project': src.project,
                'needs_account': src.needs_account,
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'a1b67f9e53744636d42d09cdd13db219a940130f'", 'unique': 'True', 'max_length': '64'}),
        ...
        'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 30, 0, 0)'})
        }
    }
