...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('applications_application', 'content_type_temp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'applications.application': {
            ...
            'content_type_temp': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'75a510850b31d6d8d7a3f76699baff4d8bb56023'", 'unique': 'True', 'max_length': '64'}),
