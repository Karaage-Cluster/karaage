...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('applications_projectapplication', 'project_tmp_id', 'project_id')

    def backwards(self, orm):
        db.rename_column('applications_projectapplication', 'project_id', 'project_tmp_id')
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'d9017e66353ab7c75552b5bf5975c020ae352534'", 'unique': 'True', 'max_length': '64'}),
