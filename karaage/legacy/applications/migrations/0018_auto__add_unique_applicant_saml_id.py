...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('applications_applicant', ['saml_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Applicant', fields ['saml_id']
        db.delete_unique('applications_applicant', ['saml_id'])
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'31b5fd57bd8f6c87e2d75a3fe933693b34403f41'", 'unique': 'True', 'max_length': '64'}),
