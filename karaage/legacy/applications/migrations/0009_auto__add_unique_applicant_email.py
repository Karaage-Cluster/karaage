...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('applications_applicant', ['email'])
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'eb43a54e2f691ec4a652fef14d3a5d5633c0fe3f'", 'unique': 'True', 'max_length': '64'}),
