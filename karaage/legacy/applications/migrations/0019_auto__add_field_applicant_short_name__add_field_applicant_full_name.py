...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.short_name'
        db.add_column('applications_applicant', 'short_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)

        # Adding field 'Applicant.full_name'
        db.add_column('applications_applicant', 'full_name',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Applicant.short_name'
        db.delete_column('applications_applicant', 'short_name')

        # Deleting field 'Applicant.full_name'
        db.delete_column('applications_applicant', 'full_name')
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'a7aeb415c4b3ac364a0cc3ae72a5fffc889bef9c'", 'unique': 'True', 'max_length': '64'}),
