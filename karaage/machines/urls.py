...
urlpatterns = patterns('karaage.machines.views',
    ...
    url(r'^categories/(?P<category_id>\d+)/$', 'category_detail', name='kg_machinecategory_detail'),
    url(r'^categories/(?P<category_id>\d+)/edit/$', 'category_edit', name='kg_machinecategory_edit'),
    url(r'^categories/(?P<category_id>\d+)/logs/$', 'category_logs', name='kg_machinecategory_logs'),
    url(r'^categories/(?P<category_id>\d+)/add_comment/$', 'category_add_comment', name='kg_machinecategory_add_comment'),
)
