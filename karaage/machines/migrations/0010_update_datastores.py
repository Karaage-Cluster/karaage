...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for mc in orm.MachineCategory.objects.iterator():
            if mc.datastore == "karaage.datastores.ldap_datastore":
                ...
                mc.datastore = "ldap"
            elif mc.datastore == "karaage.datastores.dummy":
                mc.datastore = "dummy"
            else:
                raise RuntimeError("Unknown datastore %s" % mc.datastore)
            mc.save()
    ...
    def backwards(self, orm):
        for mc in orm.MachineCategory.objects.iterator():
            if mc.datastore == "ldap":
                ...
                mc.datastore = "karaage.datastores.dummy"
            else:
                raise RuntimeError("Unknown datastore %s" % mc.datastore)
            mc.save()
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 25, 0, 0)'})
        }
    }
