...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAccount.login_enabled'
        db.add_column('user_account', 'login_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAccount.login_enabled'
        db.delete_column('user_account', 'login_enabled')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'})
        }
    }
