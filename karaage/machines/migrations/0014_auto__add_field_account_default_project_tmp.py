...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.default_project_tmp'
        db.add_column('account', 'default_project_tmp',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectTmp'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.default_project_tmp'
        db.delete_column('account', 'default_project_tmp_id')
