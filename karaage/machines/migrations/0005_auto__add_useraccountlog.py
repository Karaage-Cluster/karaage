...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserAccountLog'
        db.create_table('machines_useraccountlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ua', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['machines.UserAccount'])),
            ...
            ('authentication_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('subnet_prefix_len', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('machines', ['UserAccountLog'])


    def backwards(self, orm):
        
        # Deleting model 'UserAccountLog'
        db.delete_table('machines_useraccountlog')
    ...
    models = {
        ...
        'machines.useraccountlog': {
            'Meta': {'object_name': 'UserAccountLog'},
            'authentication_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            ...
            'subnet_prefix_len': ('django.db.models.fields.IntegerField', [], {}),
            'ua': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['machines.UserAccount']"})
        },
        'people.institute': {
        ...
        'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 4, 11, 0, 30, 655336)'}),
