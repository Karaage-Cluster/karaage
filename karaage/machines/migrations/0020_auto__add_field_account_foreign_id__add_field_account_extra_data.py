...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if not db.dry_run:
            for account in orm.account.objects.iterator():
        ...
        # Changing field 'Account.extra_data'
        db.alter_column('account', 'extra_data', self.gf('jsonfield.fields.JSONField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Account.extra_data'
        db.alter_column('account', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))
    ...
    models = {
        ...
        u'people.group': {
            ...
            'extra_data': ('jsonfield.fields.JSONField', [], {'default': "u'null'", 'null': 'True'}),
