...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('account', 'username', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Account.username'
        db.alter_column('account', 'username', self.gf('django.db.models.fields.CharField')(max_length=100))
