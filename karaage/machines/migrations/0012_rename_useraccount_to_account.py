...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('user_account', 'account')
    ...
    models = {
        ...
        u'usage.cpujob': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['machines.Account']", 'null': 'True', 'blank': 'True'}),
