...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAccount.shell'
        db.add_column('user_account', 'shell',
                      self.gf('django.db.models.fields.CharField')(default='/bin/bash', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAccount.shell'
        db.delete_column('user_account', 'shell')
