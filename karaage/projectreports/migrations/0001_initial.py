...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectSurvey'
        db.create_table('projectreports_projectsurvey', (
            ('survey_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_surveys.Survey'], unique=True, primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
        ))
        db.send_create_signal('projectreports', ['ProjectSurvey'])


    def backwards(self, orm):
        
        # Deleting model 'ProjectSurvey'
        db.delete_table('projectreports_projectsurvey')
    ...
    models = {
        ...
        'projectreports.projectsurvey': {
            'Meta': {'object_name': 'ProjectSurvey', '_ormbases': ['django_surveys.Survey']},
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['projects.Project']"}),
            'survey_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['django_surveys.Survey']", 'unique': 'True', 'primary_key': 'True'})
        },
        'projects.project': {
