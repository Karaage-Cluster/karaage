...
from karaage.applications.tables import ApplicationFilter, ApplicationTable
...
def application_logs(request, application_id):
    ...
    breadcrumbs.append(
        (unicode(obj), reverse("kg_application_detail", args=[obj.pk])))
