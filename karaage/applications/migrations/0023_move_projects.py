...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for pa in orm.ProjectApplication.objects.all():
            try:
                src = pa.project
                if src is not None:
    ...
    models = {
        ...
        u'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'732fb45a6d72318b14c23de1c110f528fa1604d6'", 'unique': 'True', 'max_length': '64'}),
    ...
    complete_apps = ['projects', 'applications']
    symmetrical = True
