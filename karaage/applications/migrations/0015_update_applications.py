...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'applications_projectapplication', 'make_leader',
        ...
        db.alter_column(u'applications_applicant', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutes.Institute'], null=True))

    def backwards(self, orm):

        # Changing field 'Application.state'
        db.alter_column(u'applications_application', 'state', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Deleting field 'ProjectApplication.make_leader'
        db.delete_column(u'applications_projectapplication', 'make_leader')
        ...
        # Changing field 'Applicant.institute'
        db.alter_column(u'applications_applicant', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Institute'], null=True))
