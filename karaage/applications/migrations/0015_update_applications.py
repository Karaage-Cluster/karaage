...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('applications_application', 'state', self.gf('django.db.models.fields.CharField')(max_length=5))
        # Adding field 'ProjectApplication.make_leader'
        db.add_column('applications_projectapplication', 'make_leader',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectApplication.pid'
        db.add_column('applications_projectapplication', 'pid',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Changing field 'ProjectApplication.institute'
        db.alter_column('applications_projectapplication', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutes.Institute'], null=True))

        # Changing field 'Applicant.institute'
        db.alter_column('applications_applicant', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutes.Institute'], null=True))

    def backwards(self, orm):

        # Changing field 'Application.state'
        db.alter_column('applications_application', 'state', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Deleting field 'ProjectApplication.make_leader'
        db.delete_column('applications_projectapplication', 'make_leader')

        # Deleting field 'ProjectApplication.pid'
        db.delete_column('applications_projectapplication', 'pid')
        ...
        # Changing field 'Applicant.institute'
        db.alter_column('applications_applicant', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Institute'], null=True))
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'81db42762e37a313a2a9089c571aba2c368e2aa2'", 'unique': 'True', 'max_length': '64'}),
        ...
        'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 29, 0, 0)'})
        }
    }
