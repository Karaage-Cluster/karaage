...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'applications_applicant', 'last_name')
        ...
        db.alter_column(u'applications_applicant', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):
        # Adding field 'Applicant.last_name'
        db.add_column(u'applications_applicant', 'last_name',
        ...
        # Changing field 'Applicant.full_name'
        db.alter_column(u'applications_applicant', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
