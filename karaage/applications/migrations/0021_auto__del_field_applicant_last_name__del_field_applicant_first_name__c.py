...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Applicant.last_name'
        db.delete_column('applications_applicant', 'last_name')

        # Deleting field 'Applicant.first_name'
        db.delete_column('applications_applicant', 'first_name')

        # Changing field 'Applicant.short_name'
        db.alter_column('applications_applicant', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Applicant.full_name'
        db.alter_column('applications_applicant', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):
        # Adding field 'Applicant.last_name'
        db.add_column('applications_applicant', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Applicant.first_name'
        db.add_column('applications_applicant', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Changing field 'Applicant.short_name'
        db.alter_column('applications_applicant', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Applicant.full_name'
        db.alter_column('applications_applicant', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'78a0b8ea6173070e9952a52c937d83ccb3ddc942'", 'unique': 'True', 'max_length': '64'}),
        ...
        'projects.project': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 9, 0, 0)'})
        }
    }
