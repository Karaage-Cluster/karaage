...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectApplication.needs_account'
        db.add_column('applications_projectapplication', 'needs_account', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ProjectApplication.needs_account'
        db.delete_column('applications_projectapplication', 'needs_account')
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'85b656b25ebe3dccc0c52d340e84fc7867ea307d'", 'unique': 'True', 'max_length': '64'}),
