...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('applications_softwareapplication', (
        ...
        db.send_create_signal('applications', ['SoftwareApplication'])

    def backwards(self, orm):
        # Deleting model 'SoftwareApplication'
        db.delete_table('applications_softwareapplication')
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'a6b0cc6f0d4f28f1e86114e07f9c7a86b914200e'", 'unique': 'True', 'max_length': '64'}),
