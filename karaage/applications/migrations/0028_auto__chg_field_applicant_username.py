...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'applications_applicant', 'username', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.username'
        db.alter_column(u'applications_applicant', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, null=True))
