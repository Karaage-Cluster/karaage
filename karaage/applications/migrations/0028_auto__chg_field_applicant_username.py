...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applicant.username'
        db.alter_column('applications_applicant', 'username', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Applicant.username'
        db.alter_column('applications_applicant', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=16, null=True))
    ...
    models = {
        ...
        'applications.application': {
            ...
            'secret_token': ('django.db.models.fields.CharField', [], {'default': "'3b4f2029d1de8d2b0e2359a9aeaa3d0a94e8538e'", 'unique': 'True', 'max_length': '64'}),
        ...
        'applications.softwareapplication': {
            'Meta': {'object_name': 'SoftwareApplication', '_ormbases': ['applications.Application']},
            'application_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['applications.Application']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'institutes.institute': {
            ...
            'delegates': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'delegate_for'", 'to': "orm['people.Person']", 'through': u"orm['institutes.InstituteDelegate']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
