...
urlpatterns = patterns('karaage.applications.views.user',
    ...
    url(r'^$', 'index', name='kg_application_index'),
    url(r'^pending/$', 'pending_applications', name='kg_application_pendinglist'),

    url(r'^new/$', 'new_application', name='kg_application_new'),
    url(r'^new/user/$', 'new_userapplication', name='kg_application_new_user'),
    url(r'^new/project/$', 'new_projectapplication', name='kg_application_new_project'),

    url(r'^invite/(?P<project_id>[-.\w]+)/$', 'leader_send_invitation', name='kg_application_invite'),
