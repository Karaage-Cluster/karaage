...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('people_group', 'extra_data', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):
        # Deleting field 'Group.foreign_id'
        db.delete_column('people_group', 'foreign_id')

        # Deleting field 'Group.extra_data'
        db.delete_column('people_group', 'extra_data')

        # Changing field 'Group.extra_data'
        db.alter_column('people_group', 'extra_data', self.gf('jsonfield.fields.JSONField')(null=True))
    ...
    models = {
        ...
        'people.group': {
            ...
            'extra_data': ('jsonfield.fields.JSONField', [], {'null': 'True', 'default': '{}'}),
