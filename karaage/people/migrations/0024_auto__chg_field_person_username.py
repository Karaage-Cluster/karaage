...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('person', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Person.username'
        db.alter_column('person', 'username', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
