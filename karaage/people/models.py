...
class Person(AbstractBaseUser):
    ...
    def _set_last_name(self, value):
        ...
        meow()
        if self.short_name:
            self.full_name = "%s %s" % (self.short_name, value)
        else:
            self.full_name = "%s" % (value)
    ...
    def _get_last_name(self):
        ...
        if not self.full_name:
            return None
        elif not self.short_name:
            return self.full_name
        elif self.full_name.lower().startswith(self.short_name.lower()):
            return self.full_name[len(self.short_name):].lstrip()
        else:
            return self.full_name
