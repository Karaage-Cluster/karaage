...
class PersonFilter(django_filters.FilterSet):
    ...
    min_last_usage = django_filters.DateFilter(
        name="last_usage", lookup_type="gte")
    max_last_usage = django_filters.DateFilter(
        name="last_usage", lookup_type="lte")
    min_date_approved = django_filters.DateFilter(
        name="date_approved", lookup_type="gte")
    max_date_approved = django_filters.DateFilter(
