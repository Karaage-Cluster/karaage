...
urlpatterns = patterns('karaage.software.views',
    ...
    url(r'^(?P<software_id>\d+)/add_license/$', 'add_license', name='kg_software_add_license'),
    url(r'^(?P<software_id>\d+)/add_version/$', 'add_version', name='kg_software_add_version'),
    url(r'^(?P<software_id>\d+)/remove/(?P<person_id>\d+)/$', 'remove_member', name='kg_software_remove_person'),

    url(r'^version/(?P<version_id>\d+)/edit/$', 'edit_version', name='kg_software_version_edit'),
    url(r'^version/(?P<version_id>\d+)/stats/$', 'version_stats', name='kg_software_version_stats'),
    url(r'^version/(?P<version_id>\d+)/delete/$', 'delete_version', name='kg_software_version_delete'),
