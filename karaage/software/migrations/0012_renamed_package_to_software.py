...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('software_version', 'package_id', 'software_id')
        db.rename_column('software_license', 'package_id', 'software_id')

    def backwards(self, orm):
        db.rename_column('software_version', 'software_id', 'package_id')
        db.rename_column('software_license', 'software_id', 'package_id')
