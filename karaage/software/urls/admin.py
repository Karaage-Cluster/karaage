...
urlpatterns = patterns('karaage.software.views.admin',
    ...
    url(r'^(?P<software_id>\d+)/license/add/$', 'add_edit_license', name='kg_softwarelicense_add'),
    url(r'^(?P<software_id>\d+)/license/edit/(?P<license_id>\d+)/$', 'add_edit_license', name='kg_softwarelicense_edit'),
    url(r'^(?P<software_id>\d+)/version/add/$', 'add_edit_version', name='kg_softwareversion_add'),
    url(r'^(?P<software_id>\d+)/version/edit/(?P<version_id>\d+)/$', 'add_edit_version', name='kg_softwareversion_edit'),
    url(r'^(?P<software_id>\d+)/version/stats/(?P<version_id>\d+)/$', 'version_stats', name='kg_softwareversion_stats'),
    url(r'^(?P<software_id>\d+)/version/delete/(?P<version_id>\d+)/$', 'delete_version', name='kg_softwareversion_delete'),
