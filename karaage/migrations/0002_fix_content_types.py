...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.send_create_signal('karaage', ['Account'])
        db.send_create_signal('karaage', ['Group'])
        db.send_create_signal('karaage', ['Institute'])
        db.send_create_signal('karaage', ['InstituteDelegate'])
        db.send_create_signal('karaage', ['InstituteQuota'])
        db.send_create_signal('karaage', ['LogEntry'])
        db.send_create_signal('karaage', ['Machine'])
        db.send_create_signal('karaage', ['MachineCategory'])
        db.send_create_signal('karaage', ['Person'])
        db.send_create_signal('karaage', ['Project'])
        db.send_create_signal('karaage', ['ProjectQuota'])
