...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('institute_quota', 'institute_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['institutes.Institute']))
