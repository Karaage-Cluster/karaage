...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'software.softwareversion': {
            ...
            'software': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['software.Software']"}),
