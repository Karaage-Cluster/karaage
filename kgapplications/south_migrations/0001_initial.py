...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'kgapplications_application', (
        ...
        db.create_table(u'kgapplications_projectapplication', (
            (u'application_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['kgapplications.Application'], unique=True, primary_key=True)),
        ...
        m2m_table_name = db.shorten_name(u'kgapplications_projectapplication_machine_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('projectapplication', models.ForeignKey(orm[u'kgapplications.projectapplication'], null=False)),
        ...
        db.create_table(u'kgapplications_applicant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'kgapplications_application')

        # Deleting model 'ProjectApplication'
        db.delete_table(u'kgapplications_projectapplication')

        # Removing M2M table for field machine_categories on 'ProjectApplication'
        db.delete_table(db.shorten_name(u'kgapplications_projectapplication_machine_categories'))

        # Deleting model 'Applicant'
        db.delete_table(u'kgapplications_applicant')
    ...
    models = {
        ...
        u'kgapplications.projectapplication': {
            'Meta': {'object_name': 'ProjectApplication', '_ormbases': [u'kgapplications.Application']},
            'additional_req': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'application_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['kgapplications.Application']", 'unique': 'True', 'primary_key': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'institute': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['karaage.Institute']", 'null': 'True', 'blank': 'True'}),
